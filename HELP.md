...
* The original package name 'com.khargharnewlaunches.realestate-backend' is invalid and this project uses 'com.khargharnewlaunches.realestate_backend' instead.
